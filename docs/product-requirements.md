...
- **Primary:** [`personas/co-payer-member-vn.md`](../personas/co-payer-member-vn.md) — An, thành viên active kiêm payer vãng lai (bill nhỏ: cafe, ship, taxi) + nợ ròng 2 chiều
- **Secondary:** [`personas/group-member-vn.md`](../personas/group-member-vn.md) — Linh, thành viên mắc nợ, cần thanh toán nhanh qua QR
- **Secondary:** [`personas/casual-guest-vn.md`](../personas/casual-guest-vn.md) — Duy, khách mới được mời vào nhóm lần đầu, onboarding nhanh
- **Secondary:** [`personas/bill-skeptic-vn.md`](../personas/bill-skeptic-vn.md) — Tú, thành viên soi số liệu, verify + edit split ratios
...
| Bill mở check-in abuse (check nhiều lần, fake) | Low | Unique constraint per user_id + bill_id; payer/admin có thể edit/delete bill qua ⋯ menu (decision 2026-04-18: không có "Đóng bill" button) |
...
| Bill finalize (edit/delete) | Người nợ | "Bill đã được [edit/delete]. Phần bạn: [Số tiền]" |
| Notification policy | — | **Không silent mode.** Luôn notify Telegram khi có sự kiện (create/edit/delete bill, check-in, payment). Không auto-mute sau N ngày idle. User tự mute qua group settings nếu muốn (Post-MVP). |
