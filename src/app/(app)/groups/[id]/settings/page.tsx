  ...
  return (
    <div className="flex h-dvh flex-col bg-[#F2F2F7]">
      ...
      <header className="flex h-[52px] shrink-0 items-center bg-white px-4 shadow-sm">
        ...
        <h1 className="text-base font-semibold text-[#1C1C1E]">Cài đặt nhóm</h1>
      </header>
        ...
        <div className="rounded-2xl bg-white p-4 shadow-sm">
          ...
          {editingName && isAdmin ? (
            <div className="flex gap-2 items-center">
              <input
                className="flex-1 rounded-xl border border-[#E5E5EA] bg-[#F2F2F7] px-3 py-2 text-sm text-[#1C1C1E] outline-none focus:border-[#3A5CCC]"
                value={nameInput}
              ...
              <button
                ...
                className="rounded-xl border border-[#E5E5EA] px-3 py-2 text-xs text-[#8E8E93]"
              >
                Hủy
              </button>
            </div>
        ...
        <div className="rounded-2xl bg-white p-4 shadow-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="rounded-xl bg-[#3A5CCC] px-4 py-3 text-xs font-semibold text-white"
            >
              Sao chép
            </button>
          </div>
      ...
      {showLeaveConfirm && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 p-4">
          <div className="w-full max-w-sm rounded-2xl bg-white p-5 shadow-xl">
            <h3 className="mb-2 text-center text-base font-bold text-[#1C1C1E]">Rời nhóm?</h3>
